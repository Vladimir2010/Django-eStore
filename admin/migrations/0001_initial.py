# Generated by Django 3.2.20 on 2023-07-25 13:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_method', models.CharField(choices=[('Наложен платеж', 'Наложен платеж'), ('Банков път', 'Банков път')], max_length=20)),
